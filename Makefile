...
.PHONY: up down build shell composer artisan migrate seed fresh test npm logs worker-logs worker-restart worker-shell rabbitmq-queues scheduler-logs reverb-logs cutover-check

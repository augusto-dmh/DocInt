        ...
        'rabbitmq' => [
            ...
            'hosts' => [
                [
                    ...
                    'vhost' => env('RABBITMQ_VHOST', '/docintern'),
                ],
            ],
            'options' => [
                'queue' => [
            ...
            'management' => [
                ...
                'host' => env('RABBITMQ_MANAGEMENT_HOST', 'rabbitmq'),
                'port' => (int) env('RABBITMQ_MANAGEMENT_PORT', 15672),
                'username' => env('RABBITMQ_MANAGEMENT_USER', 'guest'),
                'password' => env('RABBITMQ_MANAGEMENT_PASSWORD', 'guest'),
                'vhost' => env('RABBITMQ_MANAGEMENT_VHOST', '/docintern'),

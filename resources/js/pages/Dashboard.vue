...
const liveDocumentState = ref(
    seedRealtimeDocumentState(props.pipelineDocuments),
);
...
if (props.realtimeTenantId !== null) {
    useDocumentChannel({
        ...
        onStatusUpdated: (payload) => {
            ...
            const previousStatus =
                knownState?.status === payload.to_status
                    ? knownState.status
                    : (payload.from_status ?? knownState?.status ?? null);
        ...
        >
            ...
            <div class="mt-5 space-y-3">
                ...
                <ProcessingPipeline
                    ...
                    :realtime-enabled="props.realtimeTenantId !== null"
                />
            </div>
        </section>
